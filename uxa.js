...
var Stack = __webpack_require__(15).Stack;
var Menu = __webpack_require__(16).Menu;
var Button = __webpack_require__(17).Button;
var TextField = __webpack_require__(18).TextField;
var ListItem = __webpack_require__(19).ListItem;

var snarkdown = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"snarkdown\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Overlay = _T.defineTag('Overlay', function(tag){
	...
	tag.prototype.setup = function (){
		this._isMenu = this.component().hasFlag('menu');
...
var Button = _T.defineTag('Button', 'button', function(tag){
	...
	tag.prototype.render = function (){
		...
		return this.flag('button').setChildren([
			this.icon() ? (
				(__.A = __.A || _T.I(this)).setContent(this.icon(),3).end()
			) : void(0),
			(__.B = __.B || _T.B(self)).setContent(self.label(),3).end()
		],1).synced();
	};
})
...
var ListItem = _T.defineTag('ListItem', function(tag){
	tag.prototype.leftIcon = function(v){ return this._leftIcon; }
	tag.prototype.setLeftIcon = function(v){ this._leftIcon = v; return this; };
	...
	tag.prototype.render = function (){
		...
		return this.setChildren([
			this.leftIcon() ? (
				(__.A = __.A || _T.I(this).flag('left-icon')).setContent(this.leftIcon(),3).end()
			) : void(0),
			self.label() ? (
				(__.B = __.B || _T.B(self).flag('label')).setContent(self.label(),3).end()
			) : void(0),
			self.rightIcon() ? (
				(__.C = __.C || _T.I(self).flag('left-icon')).setContent(self.rightIcon(),3).end()
			) : void(0)
		],1).synced();
	};
})
