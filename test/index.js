...
socket.onmessage = function(e) {
	...
	return (id$('uxa-css').setHref(v_ = ("uxa.css?" + (Math.random()))),v_);
};
...
var Article = _T.defineTag('Article', function(tag){
...
var Fields = _T.defineTag('Fields', function(tag){
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.setChildren([
			(__.A = __.A || _T.INPUT(this).setType('text')).end(),
			(__.B = __.B || _T.BUTTON(self).setType('button').setText("Hello")).end(),
			(__.C = __.C || Button.build(self).setLabel("Submit")).end(),
			(__.D = __.D || Button.build(self).flag('muted').setLabel("Cancel")).end()
		],2).synced();
	};
});

var Component = _T.defineTag('Component', function(tag){
	tag.prototype.__tint = {'default': 'primary',name: 'tint'};
	tag.prototype.tint = function(v){ return this._tint; }
	tag.prototype.setTint = function(v){ this._tint = v; return this; }
	tag.prototype._tint = 'primary';
	
	tag.prototype.ontap = function (){
		this.setTint(tints[tints.indexOf(this.tint()) + 1] || tints[0]);
		return this.render();
	};
});

var Alert = _T.defineTag('Alert', Component, function(tag){
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.flag('alert').setFlag(1,this.tint()).setChildren([
			(__.A = __.A || _T.H3(this).setText("This is an alert")).end(),
			(__.B = __.B || _T.DIV(self)).setMarkdown(samples.paragraph).end(),
			(__.C = __.C || _T.HR(self)).end(),
			(__.D = __.D || _T.P(self).setText("Some more info about the alert here")).end()
		],2).synced();
	};
});

var Panel = _T.defineTag('Panel', Component, function(tag){
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.flag('panel').setFlag(1,this.tint()).setChildren([
			(__.A = __.A || _T.HEADER(this).setText("My header")).end(),
			(__.B = __.B || _T.ARTICLE(self).setText("My article")).end(),
			(__.C = __.C || _T.FOOTER(self).setText("My footer")).end()
		],2).synced();
	};
});

var Texts = _T.defineTag('Texts', function(tag){
	
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.setChildren([
			(__.A = __.A || _T.H1(this)).setContent([
				"Heading 1",
				(__.AA = __.AA || _T.SPAN(this).flag('muted').setText("Context of heading")).end()
			],2).end(),
			
			(__.B = __.B || _T.H2(self).setText("Heading 2")).end(),
			(__.C = __.C || _T.H3(self).setText("Heading 3")).end(),
			(__.D = __.D || _T.HR(self)).end(),
			(__.E = __.E || _T.H4(self).setText("Heading 4")).end(),
			(__.F = __.F || _T.H5(self).setText("Heading 5")).end(),
			(__.G = __.G || _T.H6(self).setText("Heading 6")).end(),
			(__.H = __.H || _T.P(self).setText("Paragraph")).end(),
			(__.I = __.I || _T.DL(self)).setContent([
				(__.IA = __.IA || _T.DT(self).setText("Description list")).end(),
				(__.IB = __.IB || _T.DD(self).setText("A description list is perfect for defining terms.")).end(),
				(__.IC = __.IC || _T.DT(self).setText("Eusmod")).end(),
				(__.ID = __.ID || _T.DD(self).setText("Vestibulum id ligula porta felis euismod semper eget lacinia odio sem.")).end()
			],2).end(),
			(__.J = __.J || _T.DIV(self).flag('highlight')).setContent([
				(__.JA = __.JA || _T.H2(self).setText("Heading 2")).end(),
				(__.JB = __.JB || _T.P(self).flag('muted').setText("A description list is perfect for defining terms.")).end()
			],2).end()
		],2).synced();
	};
});

var Alerts = _T.defineTag('Alerts', function(tag){
	
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.setChildren([
			(__.A = __.A || _T.DIV(this).flag('alert').flag('primary').setText("This is a primary alert—check it out!")).end(),
			(__.B = __.B || _T.DIV(self).flag('alert').flag('success').setText("This is a success alert—check it out!")).end(),
			(__.C = __.C || _T.DIV(self).flag('alert').flag('danger').setText("This is a danger alert—check it out!")).end(),
			(__.D = __.D || _T.DIV(self).flag('alert').flag('warning').setText("This is a warning alert—check it out!")).end(),
			(__.E = __.E || Alert.build(self)).end()
		],2).synced();
	};
});
...
var Example = _T.defineTag('Example', function(tag){
	...
	tag.prototype.render = function (){
		var self = this, __ = self.__;
		return this.setChildren([
			(__.A = __.A || _T.ARTICLE(this).flag('panel')).setContent([
				(__.AA = __.AA || Texts.build(this)).end(),
				(__.AB = __.AB || Fields.build(self)).end(),
				(__.AC = __.AC || Alerts.build(self)).end(),
				(__.AD = __.AD || _T.DIV(self).flag('alert')).setMarkdown(ARTICLE).end()
			],2).end(),
			(__.B = __.B || _T.DIV(self).flag('panel').flag('dark')).setContent([
				(__.BA = __.BA || Texts.build(self)).end(),
				(__.BB = __.BB || Fields.build(self)).end(),
				(__.BC = __.BC || Alerts.build(self)).end()
			],2).end(),
			(__.C = __.C || Panel.build(self)).end()
		],2).synced();
	};
});


Imba.mount(Example.build(this).end());
...
var Button = _T.defineTag('Button', 'button', function(tag){
	...
	tag.prototype.render = function (){
		...
		return this.flag('button').setChildren(
			(__.A = __.A || _T.B(this)).setContent(this.label(),3).end()
		,2).synced();
	};
})
