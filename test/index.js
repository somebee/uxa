...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuItem = __webpack_require__(35).MenuItem;
	var Button$ = __webpack_require__(18), Button = Button$.Button, IconButton = Button$.IconButton;
	var TextField$ = __webpack_require__(19), TextField = TextField$.TextField, TextArea = TextField$.TextArea, SelectField = TextField$.SelectField;
	...
	UXAWrapper.prototype.mdDidSet = function (value){
		return this._owner.dom().innerHTML = md2html(this.md());
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectField = _T.defineTag('SelectField', TextField, function(tag){
		...
		tag.prototype.setOptions = function (val){
			...
			// hacky
			(t0 = self._input || _T.SELECT(this).ref_('input',this)).setContent(
				(function() {
					var t1, _$ = (t0.__.$A = t0.__.$A || []);
					for (var i = 0, ary = iter$(val), len = ary.length, item, res = []; i < len; i++) {
						item = ary[i];
						res.push((t1 = _$[i] = _$[i] || _T.OPTION(self)).setValue(item[0]).setContent(item[1] || item[0],3).end());
		...
		tag.prototype.input = function (){
			return (this._input || _T.SELECT(this).ref_('input',this)).end();
			// 	<option> "First option"
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1);
	var uxa$ = __webpack_require__(24), Button = uxa$.Button, IconButton = uxa$.IconButton, TextField = uxa$.TextField, ListItem = uxa$.ListItem, Menu = uxa$.Menu, MenuItem = uxa$.MenuItem, Popover = uxa$.Popover, Dialog = uxa$.Dialog;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uxa$ = __webpack_require__(24), IconButton = uxa$.IconButton, Button = uxa$.Button, TextField = uxa$.TextField, TextArea = uxa$.TextArea, Dialog = uxa$.Dialog, Menu = uxa$.Menu, MenuItem = uxa$.MenuItem, Form = uxa$.Form, Indicator = uxa$.Indicator, Tile = uxa$.Tile;
		...
		tag.prototype.render = function (){
			...
			return this.flag('paper').setFlag(1,this.tint()).setChildren([
				...
				(__.C = __.C || _T.SECTION(self).flag('flat')).setContent([
					...
					(__.CG = __.CG || _T.H3(self).setText("Icon buttons")).end(),
					(__.CH = __.CH || _T.DIV(self).flag('hbar')).setContent([
						(__.CHA = __.CHA || IconButton.build(self).flag('xs').setIcon('*')).end(),
						(__.CHB = __.CHB || IconButton.build(self).flag('sm').setIcon('*')).end(),
						(__.CHC = __.CHC || IconButton.build(self).flag('md').setIcon('*')).end(),
						(__.CHD = __.CHD || IconButton.build(self).flag('lg').setIcon('*')).end(),
						(__.CHE = __.CHE || IconButton.build(self).flag('xl').setIcon('*')).end()
					],2).end(),
					
					(__.CI = __.CI || _T.H3(self).setText("Floating IconButton")).end(),
					(__.CJ = __.CJ || _T.DIV(self).flag('hbar').css('position','relative')).setContent([
						(__.CJA = __.CJA || IconButton.build(self).flag('floating').flag('xs').setIcon('*')).end(),
						(__.CJB = __.CJB || IconButton.build(self).flag('floating').flag('sm').setIcon('*')).end(),
						(__.CJC = __.CJC || IconButton.build(self).flag('floating').flag('md').setIcon('*')).end(),
						(__.CJD = __.CJD || IconButton.build(self).flag('floating').flag('lg').setIcon('*')).end(),
						(__.CJE = __.CJE || IconButton.build(self).flag('floating').flag('xl').setIcon('*')).end()
					],2).end()
				],2).end(),
	...
	var Home = _T.defineTag('Home', function(tag){
		...
		tag.prototype.render = function (){
			var self = this, __ = self.__;
			return this.setChildren([
				(__.A = __.A || _T.SECTION(this)).setContent([
					(__.AA = __.AA || _T.H3(this).setText("Colors")).end(),
					(__.AB = __.AB || ColorScale.build(self).setTint('base')).end(),
					(__.AC = __.AC || ColorScale.build(self).setTint('dark')).end(),
					(__.AD = __.AD || ColorScale.build(self).setTint('pri')).end(),
					(__.AE = __.AE || ColorScale.build(self).setTint('sec')).end()
				],2).end(),
				(__.B = __.B || Palette.build(self).setTint('neutral')).end(),
				(__.C = __.C || Palette.build(self).setTint('dark')).end()
			],2).synced();
		};
	})
	exports.Home = Home;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1);
	var Form = __webpack_require__(31).Form;
	var Button = __webpack_require__(18).Button;
	var Indicator = __webpack_require__(33).Indicator;
