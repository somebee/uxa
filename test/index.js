...
/***/ function(module, exports, __webpack_require__) {
	...
	var mdconverter = new (showdown.Converter)({noHeaderId: true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextField = _T.defineTag('TextField', function(tag){
		...
		['disabled','placeholder','type','name','value','required','pattern'].map(function(key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorSample = _T.defineTag('ColorSample', function(tag){
		...
		tag.prototype.render = function (){
			var self = this, __ = self.__;
			return this.setChildren((__.A = __.A || _T.SPAN(this)).setContent(this.label(),3).end(),2).synced();
		};
	});
	...
	var Form = _T.defineTag('Form', 'form', function(tag){
		...
		tag.prototype.formData = function (){
			...
			for (var i = 0, ary = iter$(this.dom().elements), len = ary.length, field; i < len; i++) {
				...
				if (field.name) {
					o[field.name] = (field._tag ? field._tag.value() : field.value);
				};
			};
			return o;
		};
