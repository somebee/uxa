...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextField$ = __webpack_require__(19), TextField = TextField$.TextField, TextArea = TextField$.TextArea;
	...
	var Overlay = _T.defineTag('Overlay', function(tag){
		...
		tag.prototype.render = function (){
			...
			return this.setChildren([
				...
				(__.A = __.A || _T.DIV(this).flag('curtain').setHandler('tap','autohide',this)).end()
			],1).synced();
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DialogExample = _T.defineTag('DialogExample', Button, function(tag){
		tag.prototype.ontap = function (){
			if (this._template) {
				return this.uxa().open(this.template());
			};
		};
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog = _T.defineTag('Dialog', Form, function(tag){
		...
		tag.prototype.indicator = function (){
			return (this._indicator || Indicator.build(this).ref_('indicator',this)).end();
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Indicator = _T.defineTag('Indicator', function(tag){
		...
		tag.prototype.setProgress = function(v){ this._progress = v; return this; };
		...
		tag.prototype.__state = {watch: 'stateDidSet',name: 'state'};
		...
		tag.prototype.setup = function (){
			var self = this;
			if (true && self.type() == 'forward') {
				return self.dom().addEventListener('transitionend',function(e) {
					return self.transitioned(e);
				});
			};
		};
		...
		tag.prototype.run = function (){
			...
			if (self.state() == 'done') {
				self.start();
				setTimeout(function() { return self.stop(); },30);
			};
			return self;
		};
		
		tag.prototype.transitioned = function (e){
			var v_;
			if (this.state() == 'start') {
		...
		tag.prototype.stateDidSet = function (state){
			return this.setFlag('state',state);
		};
